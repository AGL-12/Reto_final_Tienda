...
public class VistaCarrito extends JDialog implements ActionListener {
	...
	private void inicializarTabla() {
		...
		model = new DefaultTableModel(columnNames, 0) {
			...
			public Class<?> getColumnClass(int columnIndex) {
				...
				case 3:
				case 4:
					return Float.class; // Descuento, Precio Final, Precio Total
				default:
					return Object.class;
				}
			}
	...
	private void calcularYMostrarTotal() {
		...
		for (Compra com : localListaCompra) {
			...
			if (arti != null) {
				...
				model.addRow(new Object[] { arti.getNombre(), com.getCantidad(), descuentoUnidad, // Mostrar descuento
																									// por unidad
	...
	// Constructor vacío (si es necesario por alguna razón, aunque no parece usarse
	// aquí)
	public VistaCarrito() {
		...
		// Inicializa componentes básicos para evitar NullPointerExceptions si se
		// muestra accidentalmente
